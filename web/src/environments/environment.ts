...
export const environment = {
  ...
  apiBaseUrl: 'https://storage-app-api.onrender.com/api',
  supabaseUrl: 'https://wvwrrkymwyvgsvbuzmep.supabase.co',
  supabaseAnonKey: 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6Ind2d3Jya3ltd3l2Z3N2YnV6bWVwIiwicm9sZSI6ImFub24iLCJpYXQiOjE3ODQ5NTAxNzMsImV4cCI6MjEwMDUyNjE3M30.sDE5PmQ5bMFVuzqqQyccm2BY8yV7eS4zihAobGnw7N4',
